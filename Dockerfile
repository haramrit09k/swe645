...
# COPY --from=build /home/app/target/student-survey-form-0.0.1-SNAPSHOT.war /usr/local/tomcat/webapps/student-survey-form.war
ADD home/app/target/student-survey-form-0.0.1-SNAPSHOT.war /usr/local/tomcat/webapps/
